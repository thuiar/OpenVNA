...
from model_api.models.networks import tools
from config import DEVICE, CUDA_VISIBLE_DEVICES
...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        if DEVICE == 'cuda':
            self.device = torch.device(f'cuda:{CUDA_VISIBLE_DEVICES}')
        else:
