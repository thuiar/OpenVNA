...
var index$_ = require('./components/tooltip-v2/index.js');
var index$$ = require('./components/transfer/index.js');
var index$10 = require('./components/tree/index.js');
var index$11 = require('./components/tree-select/index.js');
var index$12 = require('./components/tree-v2/index.js');
var index$13 = require('./components/upload/index.js');
...
var Components = [
  ...
  index$S.ElSwitch,
  index$T.ElTable,
  index$T.ElTableColumn,
  index$3.ElTableV2,
  index$U.ElTabs,
  index$U.ElTabPane,
  index$V.ElTag,
  index$W.ElTimePicker,
  index$X.ElTimeSelect,
  index$Y.ElTimeline,
  index$Y.ElTimelineItem,
  index$Z.ElTooltip,
  index$_.ElTooltipV2,
  index$$.ElTransfer,
  index$10.ElTree,
  index$11.ElTreeSelect,
  index$12.ElTreeV2,
  index$13.ElUpload
];
