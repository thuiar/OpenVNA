...
declare const _default: import("vue").DefineComponent<{
    ...
    ElCheckbox: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        CheckboxButton: import("vue").DefineComponent<{
            ...
            } & import("vue").ToRefs<Pick<import("element-plus/es/components/checkbox").CheckboxGroupProps, "size" | "disabled" | "validateEvent" | "min" | "max" | "fill" | "textColor">>) | undefined;
            ns: {
                namespace: import("vue").Ref<string>;
                b: (blockSuffix?: string) => string;
                e: (element?: string | undefined) => string;
        ...
        CheckboxGroup: import("vue").DefineComponent<{
            ...
            emit: ((event: "update:modelValue", val: import("element-plus/es/components/checkbox").CheckboxValueType[]) => void) & ((event: "change", val: import("element-plus/es/components/checkbox").CheckboxValueType[]) => void);
            ns: {
                namespace: import("vue").Ref<string>;
                b: (blockSuffix?: string) => string;
                e: (element?: string | undefined) => string;
            ...
            isLabeledByFormItem: import("vue").ComputedRef<boolean>;
            changeEvent: (value: import("element-plus/es/components/checkbox").CheckboxValueType[]) => Promise<void>;
            modelValue: import("vue").WritableComputedRef<import("element-plus/es/components/checkbox").CheckboxValueType[]>;
        }, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {
            "update:modelValue": (val: import("element-plus/es/components/checkbox").CheckboxValueType[]) => boolean;
            change: (val: import("element-plus/es/components/checkbox").CheckboxValueType[]) => boolean;
        }, string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
