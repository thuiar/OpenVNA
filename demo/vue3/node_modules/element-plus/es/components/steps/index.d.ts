export declare const ElSteps: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly finishStatus: import("element-plus/es/utils").EpPropFinalized<StringConstructor, "success" | "error" | "wait" | "process" | "finish", unknown, "finish", boolean>;
    readonly processStatus: import("element-plus/es/utils").EpPropFinalized<StringConstructor, "success" | "error" | "wait" | "process" | "finish", unknown, "process", boolean>;
}, {
